...
const PRODUCTS = {
  prescription: [
    ...
    {id:'rx003',name:'Acyclovir Ointment 5%',price:12.00},
    {id:'rx004',name:'Albuterol HFA Inhaler 8.5gm',price:18.00},
    {id:'rx005',name:'Allopurinol 100mg',price:10.00},
    {id:'rx006',name:'Allopurinol 300mg',price:14.00},
    ...
    {id:'rx017',name:'Aripiprazole 2mg',price:6.00},
    {id:'rx018',name:'Aripiprazole 5mg',price:8.00},
    {id:'rx019',name:'Aripiprazole 10mg',price:10.00},
    {id:'rx020',name:'Atenolol 50mg',price:8.00},
    {id:'rx021',name:'Atomoxetine 10mg',price:12.00},
    {id:'rx022',name:'Atomoxetine 18mg',price:14.00},
    {id:'rx023',name:'Atomoxetine 25mg',price:17.00},
    ...
    {id:'rx027',name:'Azithromycin 250mg',price:10.00},
    {id:'rx028',name:'Azithromycin 500mg',price:12.00},
    {id:'rx029',name:'Bicalutamide 50mg',price:35.00},
    {id:'rx030',name:'Bupropion XL 150mg',price:10.00},
    {id:'rx032',name:'Carbidopa/Levodopa 25-100mg',price:12.00},
    {id:'rx033',name:'Carbamazepine 200mg',price:18.00},
    {id:'rx034',name:'Carvedilol 3.125mg',price:8.00},
    {id:'rx035',name:'Carvedilol 6.25mg',price:8.00},
    {id:'rx036',name:'Carvedilol 12.5mg',price:12.00},
    {id:'rx037',name:'Carvedilol 25mg',price:12.00},
    {id:'rx038',name:'Cefuroxime 500mg',price:12.00},
    {id:'rx039',name:'Celecoxib 200mg',price:14.00},
    {id:'rx040',name:'Cephalexin 500mg',price:16.00},
    {id:'rx041',name:'Ciprofloxacin 500mg',price:18.00},
    {id:'rx042',name:'Clindamycin 150mg',price:18.00},
    {id:'rx043',name:'Clindamycin 300mg',price:20.00},
    {id:'rx044',name:'Clonidine 0.1mg',price:8.00},
    {id:'rx045',name:'Clonidine 0.2mg',price:9.00},
    {id:'rx046',name:'Clopidogrel 75mg',price:12.00},
    {id:'rx047',name:'Dibucaine 1% Ointment',price:12.00},
    {id:'rx048',name:'Diclofenac 50mg',price:8.00},
    {id:'rx049',name:'Digoxin 250mcg',price:10.00},
    {id:'rx050',name:'Diltiazem 120mg',price:20.00},
    {id:'rx051',name:'Donepezil 5mg',price:8.00},
    {id:'rx053',name:'Doxycycline Hyclate 100mg',price:9.00},
    {id:'rx055',name:'Emtricitabine/Tenofovir 200/300mg',price:30.00},
    {id:'rx056',name:'Esomeprazole 40mg',price:12.00},
    {id:'rx057',name:'Fenofibrate 160mg',price:14.00},
    {id:'rx058',name:'Finasteride 5mg',price:12.00},
    {id:'rx059',name:'Fluconazole 150mg',price:9.00},
    {id:'rx060',name:'Fluconazole Susp 10mg/ml',price:12.00},
    {id:'rx061',name:'Fluoxetine 20mg',price:12.00},
    {id:'rx063',name:'Furosemide 20mg',price:10.00},
    {id:'rx064',name:'Furosemide 40mg',price:12.00},
    {id:'rx065',name:'Gabapentin 100mg',price:10.00},
    {id:'rx066',name:'Gabapentin 300mg',price:14.00},
    {id:'rx067',name:'Glimepiride 2mg',price:10.00},
    {id:'rx068',name:'Glipizide 10mg',price:10.00},
    {id:'rx069',name:'Haloperidol 5mg',price:14.00},
    ...
    {id:'rx073',name:'Hydrocortisone 1% Oint',price:6.00},
    {id:'rx074',name:'Hydrocortisone 10mg Tabs',price:18.00},
    ...
    {id:'rx088',name:'Levothyroxine 50mcg',price:10.00},
    {id:'rx089',name:'Levothyroxine 75mcg',price:12.00},
    ...
    {id:'rx097',name:'Losartan 50mg',price:10.00},
    {id:'rx098',name:'Losartan 100mg',price:12.00},
    {id:'rx099',name:'Losartan/HCTZ 50/12.5mg',price:14.00},
    {id:'rx100',name:'Losartan/HCTZ 100/12.5mg',price:16.00},
    {id:'rx101',name:'Meloxicam 7.5mg',price:10.00},
    {id:'rx102',name:'Meloxicam 15mg',price:12.00},
    {id:'rx103',name:'Metformin 500mg',price:8.00},
    {id:'rx104',name:'Methimazole 5mg',price:14.00},
    {id:'rx105',name:'Methimazole 10mg',price:18.00},
    {id:'rx106',name:'Metoclopramide 10mg',price:8.00},
    {id:'rx107',name:'Metoprolol Succinate XL 25mg',price:10.00},
    {id:'rx108',name:'Metoprolol Succinate XL 50mg',price:12.00},
    {id:'rx109',name:'Metoprolol Succinate XL 100mg',price:14.00},
    {id:'rx110',name:'Metoprolol Tartrate 50mg',price:8.00},
    {id:'rx111',name:'Metoprolol Tartrate 100mg',price:10.00},
    {id:'rx112',name:'Metronidazole 500mg',price:12.00},
    {id:'rx113',name:'Moxifloxacin 0.5% Ophthalmic',price:12.00},
    {id:'rx114',name:'Naproxen 500mg',price:10.00},
    {id:'rx115',name:'Nifedipine ER 30mg',price:18.00},
    ...
    {id:'rx119',name:'Nystatin Ointment',price:12.00},
    {id:'rx120',name:'Olanzapine 5mg',price:7.00},
    {id:'rx121',name:'Olanzapine 10mg',price:9.00},
    {id:'rx122',name:'Olanzapine 15mg',price:12.00},
    {id:'rx123',name:'Olanzapine 20mg',price:14.00},
  ...
  otc: [
    ...
    {id:'otc006',name:'Acne Medication 5%',price:14.00},
    {id:'otc007',name:'Acne Medication 10%',price:16.00},
    {id:'otc008',name:'Antacid 500mg Chewable Tabs',price:5.00},
    {id:'otc009',name:'Artificial Tears Eye Drops',price:4.00},
    ...
    {id:'otc021',name:"Children's Ibuprofen 200mg/5ml",price:6.00},
    {id:'otc022',name:'Chlorpheniramine 4mg',price:8.00},
    {id:'otc023',name:'Clotrimazole 1% Cream',price:7.00},
    {id:'otc024',name:'Cold/Flu Capsules',price:4.00},
    {id:'otc025',name:'Daytime Cold/Flu Syrup',price:8.00},
    {id:'otc026',name:'Diphenhydramine Cream',price:6.00},
    {id:'otc027',name:'Fluticasone 50mcg Nasal Spray',price:18.00},
    {id:'otc028',name:'Glucose Tablets',price:6.00},
    {id:'otc029',name:'Guaifenesin DM Cough Liquid',price:8.00},
    {id:'otc030',name:'Hemorrhoidal Ointment',price:8.00},
    {id:'otc031',name:'Hydrocortisone 1% Cream',price:6.00},
    {id:'otc032',name:'Hydrocortisone 1% Ointment',price:6.00},
    {id:'otc033',name:'Ibuprofen 200mg',price:10.00},
    {id:'otc034',name:'Iron 325mg',price:10.00},
    {id:'otc035',name:'Ketoconazole 2% Cream',price:15.00},
    {id:'otc036',name:'Loperamide (Imodium) 2mg',price:4.00},
    {id:'otc037',name:'Loratadine 10mg',price:4.00},
    {id:'otc038',name:'Maalox Antacid',price:8.00},
    {id:'otc039',name:'Meclizine 25mg',price:8.00},
    {id:'otc040',name:'Melatonin 5mg',price:8.00},
    {id:'otc041',name:'Melatonin 10mg',price:10.00},
    {id:'otc042',name:'Menstrual Relief Tablets',price:4.00},
    {id:'otc043',name:'Miconazole 2% Cream',price:12.00},
    {id:'otc044',name:'Miconazole-7 Vaginal Cream',price:15.00},
    {id:'otc045',name:'Migraine Relief',price:8.00},
    {id:'otc046',name:'Milk of Magnesia',price:6.00},
    {id:'otc047',name:'Muscle Pain Rub',price:8.00},
    {id:'otc048',name:'Naproxen 220mg',price:6.00},
    {id:'otc049',name:'Nasal Spray (Afrin)',price:8.00},
    {id:'otc050',name:'Night Time Cold Relief Syrup',price:12.00},
    {id:'otc051',name:'Omeprazole 20mg',price:8.00},
    {id:'otc052',name:'Refresh Eye Drops',price:12.00},
    {id:'otc053',name:'Saline Nasal Drops',price:4.00},
    {id:'otc054',name:'Senna-Plus 8.6mg/50mg',price:6.00},
    {id:'otc055',name:'Sildenafil 50mg',price:8.00},
  ...
  vitamins: [
    ...
    {id:'vit006',name:'Co Q-10 30mg',price:10.00},
    {id:'vit007',name:'Co Q-10 50mg',price:14.00},
    {id:'vit008',name:'Co Q-10 100mg',price:16.00},
    ...
    {id:'vit013',name:'Daily Multivitamins',price:8.00},
    {id:'vit014',name:"Children's Multivitamins Chewable",price:8.00},
    {id:'vit015',name:'Fish Oil 1000mg',price:8.00},
    {id:'vit016',name:'Flaxseed Oil with Omega 3, 6, 9',price:18.00},
    ...
    {id:'vit027',name:'Saw Palmetto',price:12.00},
    {id:'vit028',name:'Vitamin B1 100mg',price:8.00},
    {id:'vit029',name:'Vitamin B12 1000mcg',price:8.00},
    {id:'vit030',name:'Vitamin B6 25mg',price:6.00},
    ...
    {id:'vit037',name:'Zinc Sulfate 50mg',price:8.00},
  ]
}
